...
def conversor_kwanza():
    ...
    if escolha == 1:
        ...
        print("{} Kz equivalem a {} Euros.".format(valor, convertAOA_EUR(valor, 0.845375, 626.17)))
...
def conversor_euro():
    ...
    if escolha == 1:
        ...
        print("\n{} Euros equivalem a {} Kz.".format(valor, convertEUR_AOA(valor, 0.845375, 626.17)))
    ...
    if escolha == 2:
        ...
        print("\n{} Euros equivalem a {} Dolares.".format(valor, convertEUR_USD(valor, 0.845375)))
    ...
    if escolha == 3:
        ...
        print("\n{} Euros equivalem a {} Reais.".format(valor, convertEUR_BRL(valor, 5.5654, 0.845375)))
    ...
    if escolha == 4:
        ...
        print("\n{} Euros equivalem a {} Libras.".format(valor, convertEUR_GBP(valor, 0.73, 0.845375)))
...
def conversor_dolar():
    ...
    if escolha == 1:
        ...
        print("\n{} Dolares equivalem a {} Kz.".format(valor, convertUSD_AOA(valor, 626.17)))
    ...
    if escolha == 2:
        ...
        print("\n{} Dolares equivalem a {} Euros.".format(valor, convertUSD_EUR(valor, 0.845375)))
    ...
    if escolha == 3:
        ...
        print("\n{} Dolares equivalem a {} Reais.".format(valor, convertUSD_BRL(valor, 5.5654)))
    ...
    if escolha == 4:
        ...
        print("\n{} Dolares equivalem a {} Libras.".format(valor, convertUSD_GBP(valor, 0.73)))
...
def conversor_reais():
    ...
    if escolha == 2:
        ...
        print("\n{} Reais equivalem a {} Euros.".format(valor, convertBRL_EUR(valor, 5.5654, 0.845375)))
    ...
    if escolha == 3:
        ...
        print("\n{} Reais equivalem a {} Dolares.".format(valor, convertBRL_USD(valor, 5.5654)))
    ...
    if escolha == 4:
        ...
        print("\n{} Reais equivalem a {} Libras.".format(valor, convertBRL_GBP(valor, 5.5654, 0.73)))
...
def conversor_libras():
    ...
    if escolha == 2:
        ...
        print("\n{} Libras equivalem a {} Euros.".format(valor, convertGPB_EUR(valor, 0.845375)))
    ...
    if escolha == 3:
        ...
        print("\n{} Libras equivalem a {} Dolares.".format(valor, convertGPB_USD(valor, 1.3736)))
    ...
    if escolha == 4:
        ...
        print("\n{} Euros equivalem a {} Reais.".format(valor, convertGBP_BRL(valor, 0.73, 5.5654)))
